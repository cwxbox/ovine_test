...
function build(siteDir, cliOptions) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        var context, bundleAnalyzer, baseConfig, buildConfig;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    context = config_1.loadContext(siteDir, cliOptions);
                    bundleAnalyzer = cliOptions.bundleAnalyzer;
                    return [4 /*yield*/, base_1.createBaseConfig(__assign(__assign({}, context), cliOptions))];
                case 1:
                    baseConfig = _b.sent();
                    buildConfig = utils_1.mergeWebpackConfig(baseConfig, {
                        optimization: {
                            minimizer: [
