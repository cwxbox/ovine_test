...
:root {
  ...
  --SubForm--addBtn-onActive-bg: #0d70be;
  --SubForm--addBtn-onActive-border: #0c69b2;
  --SubForm--addBtn-onActive-color: var(--SubForm--addBtn-color);
  --SubForm--addBtn-onHover-bg: #0e77ca;
  --SubForm--addBtn-onHover-border: #0d70be;
...
:root {
  ...
  --Nav-item-onActive-borderLeft: 0.25rem solid var(--primary);
  ...
  --Card-onModified-bg: #108cee;
  --Card-onModified-borderColor: var(--primary);
  --Card-onModified-color: var(--primary);
...
.cxd-Button--primary:active, .cxd-Button--primary.is-active {
...
.cxd-Button--secondary:active, .cxd-Button--secondary.is-active {
...
.cxd-Button--success:active, .cxd-Button--success.is-active {
...
.cxd-Button--info:active, .cxd-Button--info.is-active {
...
.cxd-Button--warning:active, .cxd-Button--warning.is-active {
...
.cxd-Button--danger:active, .cxd-Button--danger.is-active {
...
.cxd-Button--light:active, .cxd-Button--light.is-active {
...
.cxd-Button--dark:active, .cxd-Button--dark.is-active {
...
.cxd-Button--default:active, .cxd-Button--default.is-active {
...
.cxd-ArrayInput-addBtn:active, .cxd-ArrayInput-addBtn.is-active {
...
.cxd-Tabs--chrome > .cxd-Tabs-links > li:hover .chrome-tab-background > svg .chrome-tab-geometry {
  fill: var(--Tabs--chrome-onHover-bg);
}
.cxd-Tabs--chrome > .cxd-Tabs-links > li.is-active .chrome-tab-background {
  display: block;
}
.cxd-Tabs--chrome > .cxd-Tabs-links > li.is-active .chrome-tab-background > svg .chrome-tab-geometry {
...
.cxd-Carousel-arrowsControl:hover .cxd-Carousel-leftArrow {
  display: block;
}
.cxd-Carousel-arrowsControl:hover .cxd-Carousel-rightArrow {
  display: block;
}
...
.cxd-ImageControl-addBtn:active, .cxd-ImageControl-addBtn.is-active {
...
.cxd-Combo-addBtn:active, .cxd-Combo-addBtn.is-active {
  color: var(--Combo-addBtn-onActive-color);
  background: var(--Combo-addBtn-onActive-bg);
  border-color: var(--Combo-addBtn-onActive-border);
}
...
.cxd-SubForm-addBtn img.cxd-Button-icon {
  height: var(--Button-fontSize);
  vertical-align: middle;
}
...
.cxd-SubForm-addBtn:active, .cxd-SubForm-addBtn.is-active {
...
.cxd-TagControl-sugItem:active, .cxd-TagControl-sugItem.is-active {
...
.cxd-Form-item--horizontal .cxd-Form-itemColumn--lg {
  ...
  .cxd-Form-item--inline .cxd-TextControl.cxd-Form-control--sizeXs {
    min-width: auto;
    width: var(--Form-control-widthXs);
  }
  .cxd-Form-item--inline .cxd-TextControl.cxd-Form-control--sizeSm {
    min-width: auto;
    width: var(--Form-control-widthSm);
  }
  .cxd-Form-item--inline .cxd-TextControl.cxd-Form-control--sizeMd {
    min-width: auto;
    width: var(--Form-control-widthMd);
  }
  .cxd-Form-item--inline .cxd-TextControl.cxd-Form-control--sizeLg {
    min-width: auto;
    width: var(--Form-control-widthLg);
  }
...
/*# sourceMappingURL=cxd-ie11.css.map */