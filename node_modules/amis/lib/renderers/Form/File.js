...
var FileControl = /** @class */ (function (_super) {
        ...
        return value
            ? value instanceof File
                ? (_a = {
                    ...
                    _a.id = helper_1.guid(),
                    _a) : tslib_1.__assign({}, (typeof value === 'string'
                ? (_b = {
    ...
    FileControl.prototype.handleDropRejected = function (rejectedFiles, evt) {
        ...
        var files = rejectedFiles.map(function (fileRejection) {
            var _a;
            return (tslib_1.__assign(tslib_1.__assign({}, fileRejection.file), (_a = { state: 'invalid', id: helper_1.guid() }, _a[nameField] = fileRejection.file.name, _a)));
        });
        // this.setState({
        //   files: multiple
    ...
    FileControl.prototype.handleClickFile = function (file, e) {
        ...
        var api = typeof downloadUrl === 'string' && !~downloadUrl.indexOf('$')
            ? "" + downloadUrl + file[urlField]
            : downloadUrl
                ? downloadUrl
                : "" + file[urlField];
        if (api) {
            var ctx = helper_1.createObject(data, tslib_1.__assign({}, file));
            var apiObject = api_1.normalizeApi(api);
    ...
    FileControl.prototype.sendFile = function (file, cb, onProgress) {
        ...
        fn(file, receiver, {}, {
            ...
            cb(null, file, tslib_1.__assign(tslib_1.__assign({}, (isPlainObject_1.default(ret.data) ? ret.data : null)), { value: value, state: 'uploaded', id: file.id }));
        })
    ...
    FileControl.prototype.uploadBigFile = function (file, receiver, params, config, onProgress) {
        ...
        return new Promise(function (resolve, reject) {
            var _a;
            var state;
            var startApi = api_1.buildApi(config.startChunkApi, helper_1.createObject(config.data, tslib_1.__assign(tslib_1.__assign({}, params), (_a = { filename: file.name }, _a[nameField] = file.name, _a))), {
                method: 'post',
                autoAppend: true
            });
            ...
            function finishChunk(partList, state) {
                ...
                var endApi = api_1.buildApi(config.finishChunkApi, helper_1.createObject(config.data, tslib_1.__assign(tslib_1.__assign({}, params), (_a = { uploadId: state.uploadId, key: state.key }, _a[nameField] = file.name, _a.filename = file.name, _a.partList = partList, _a))), {
                    method: 'post',
                    autoAppend: true
                });
                    ...
                    isDragActive ? (react_1.default.createElement("div", { className: cx('FileControl-acceptTip') }, __('File.dragDrop'))) : (react_1.default.createElement(react_1.default.Fragment, null,
                        ...
                        Array.isArray(files) ? (react_1.default.createElement("ul", { className: cx('FileControl-list') }, files.map(function (file, index) { return (react_1.default.createElement("li", { key: file.id },
                            react_1.default.createElement("div", { className: cx('FileControl-itemInfo', {
                                ...
                                file.url || downloadUrl ? (react_1.default.createElement("a", { className: cx('FileControl-itemInfoText'), target: "_blank", rel: "noopener", href: "#", onClick: _this.handleClickFile.bind(_this, file) }, file[nameField] ||
