...
var TextControl = /** @class */ (function (_super) {
    ...
    TextControl.prototype.renderNormal = function () {
        var _a;
        var _b = this.props, ns = _b.classPrefix, cx = _b.classnames, className = _b.className, inputOnly = _b.inputOnly, value = _b.value, placeholder = _b.placeholder, onChange = _b.onChange, disabled = _b.disabled, readOnly = _b.readOnly, max = _b.max, min = _b.min, step = _b.step, clearable = _b.clearable, name = _b.name;
        var type = (_a = this.props.type) === null || _a === void 0 ? void 0 : _a.replace('native-', '');
...
var NativeDateControlRenderer = /** @class */ (function (_super) {
    tslib_1.__extends(NativeDateControlRenderer, _super);
...
var NativeTimeControlRenderer = /** @class */ (function (_super) {
    tslib_1.__extends(NativeTimeControlRenderer, _super);
...
var NativeNumberControlRenderer = /** @class */ (function (_super) {
    tslib_1.__extends(NativeNumberControlRenderer, _super);
