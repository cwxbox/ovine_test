...
var ImageControl = /** @class */ (function (_super) {
    ...
    function ImageControl(props) {
        ...
        _this_1.files = [];
        _this_1.cropper = react_1.default.createRef();
        ...
        _this_1.state = tslib_1.__assign(tslib_1.__assign({}, _this_1.state), { files: (_this_1.files = files), crop: _this_1.buildCrop(props), frameImageWidth: 0 });
        ...
        if (props.value !== nextProps.value && this.emitValue !== nextProps.value) {
            ...
            if (value) {
                files = (Array.isArray(value)
                    ...
                    var org;
                    if (obj &&
                        (org = find_1.default(_this_1.files, function (item) { return item.value === obj.value; }))) {
    ...
    ImageControl.prototype.handleImageLoaded = function (index, e) {
        ...
        img.onload = function () {
            ...
            var needUploading = !!(_this_1.current || find_1.default(files, function (file) { return file.state === 'pending'; }));
            _this_1.unmounted ||
                _this_1.setState({
                    files: (_this_1.files = files)
    ...
    ImageControl.prototype.render = function () {
        ...
        var filterFrameImage = tpl_1.filter(frameImage, this.props.data, '| raw');
                ...
                isDragActive || isDragAccept || isDragReject ? (react_1.default.createElement("div", { className: cx('ImageControl-acceptTip', {
                    ...
                    files && files.length
                        ? files.map(function (file, key) { return (react_1.default.createElement("div", { key: file.id || key, className: cx('ImageControl-item', {
                            ...
                            react_1.default.createElement(Image_1.default, { key: "image", className: cx('ImageControl-image', fixedSize ? 'Image-thumb--fixed-size' : ''), onLoad: _this_1.handleImageLoaded.bind(_this_1, key), src: file.preview || file.url, alt: file.name, thumbMode: thumbMode, thumbRatio: thumbRatio }),
