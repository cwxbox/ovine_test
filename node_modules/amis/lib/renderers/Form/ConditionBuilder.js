...
var ConditionBuilderControl = /** @class */ (function (_super) {
    ...
    ConditionBuilderControl.prototype.render = function () {
        ...
        return (react_1.default.createElement("div", { className: cx("ConditionBuilderControl", className) },
            react_1.default.createElement(ConditionBuilderWithRemoteOptions, tslib_1.__assign({}, rest))));
    };
...
var ConditionBuilderWithRemoteOptions = WithRemoteConfig_1.withRemoteConfig({
    ...
    class_1.prototype.render = function () {
        var _a = this.props, loading = _a.loading, config = _a.config, rest = tslib_1.__rest(_a, ["loading", "config"]);
        return (react_1.default.createElement(index_1.default, tslib_1.__assign({}, rest, { fields: config || rest.fields || [], disabled: loading })));
    };
    return class_1;
