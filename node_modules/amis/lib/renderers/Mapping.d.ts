...
export declare const MappingField: {
    new (props: Pick<MappingProps, string | number> | Readonly<Pick<MappingProps, string | number>>): {
        ref: any;
        store?: ({
            id: string;
            path: string;
        ...
        render(): JSX.Element;
        context: any;
        setState<K extends never>(state: {} | ((prevState: Readonly<{}>, props: Readonly<Pick<MappingProps, string | number>>) => {} | Pick<{}, K> | null) | Pick<{}, K> | null, callback?: (() => void) | undefined): void;
        forceUpdate(callback?: (() => void) | undefined): void;
        readonly props: Readonly<Pick<MappingProps, string | number>> & Readonly<{
        ...
        shouldComponentUpdate?(nextProps: Readonly<Pick<MappingProps, string | number>>, nextState: Readonly<{}>, nextContext: any): boolean;
        componentDidCatch?(error: Error, errorInfo: React.ErrorInfo): void;
        getSnapshotBeforeUpdate?(prevProps: Readonly<Pick<MappingProps, string | number>>, prevState: Readonly<{}>): any;
        componentDidUpdate?(prevProps: Readonly<Pick<MappingProps, string | number>>, prevState: Readonly<{}>, snapshot?: any): void;
        componentWillMount?(): void;
        UNSAFE_componentWillMount?(): void;
        componentWillReceiveProps?(nextProps: Readonly<Pick<MappingProps, string | number>>, nextContext: any): void;
        UNSAFE_componentWillReceiveProps?(nextProps: Readonly<Pick<MappingProps, string | number>>, nextContext: any): void;
        componentWillUpdate?(nextProps: Readonly<Pick<MappingProps, string | number>>, nextState: Readonly<{}>, nextContext: any): void;
        UNSAFE_componentWillUpdate?(nextProps: Readonly<Pick<MappingProps, string | number>>, nextState: Readonly<{}>, nextContext: any): void;
    };
    new (props: Pick<MappingProps, string | number>, context: any): {
        ref: any;
        store?: ({
            id: string;
            path: string;
