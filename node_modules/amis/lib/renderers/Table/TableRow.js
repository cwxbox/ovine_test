...
var TableRow = /** @class */ (function (_super) {
    ...
    function TableRow(props) {
        ...
        _this.reaction = mobx_1.reaction(function () {
            return "" + item.isHover + item.checked + item.checkdisable + JSON.stringify({
                data: item.data,
                rowSpans: item.rowSpans
            }) + item.moved + item.modified + item.expanded + (parent === null || parent === void 0 ? void 0 : parent.expanded) + columns.length;
    ...
    TableRow.prototype.shouldComponentUpdate = function (nextProps) {
        ...
        else if (nextProps.columns.some(function (column) { return column.pristine.tpl; })) {
            return true;
        }
