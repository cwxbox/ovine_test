...
exports.Row = mobx_state_tree_1.types
    ...
    get locals() {
        ...
        return helper_1.createObject(helper_1.extendObject(mobx_state_tree_1.getParent(self, self.depth * 2).data, {
            ...
            ? tslib_1.__assign(tslib_1.__assign({}, self.data), { children: children }) : self.data);
    },
    get checkable() {
        var table = mobx_state_tree_1.getParent(self, self.depth * 2);
...
exports.TableStore = iRenderer_1.iRendererStore
    ...
    function initRows(rows, getEntryId) {
        ...
        var arr = rows.map(function (item, index) {
            var id = getEntryId ? getEntryId(item, index) : helper_1.guid();
            return {
    ...
    function toggleExpandAll() {
        if (self.allExpanded) {
            ...
            self.expandedRows.replace(self.rows.filter(function (item) { return item.expandable; }));
        }
    }
