...
var QueryBuilder = /** @class */ (function (_super) {
    ...
    QueryBuilder.prototype.render = function () {
        var _a = this.props, cx = _a.classnames, fields = _a.fields, funcs = _a.funcs, onChange = _a.onChange, value = _a.value, showNot = _a.showNot, data = _a.data, disabled = _a.disabled;
        ...
        return (react_1.default.createElement(Group_1.default, { config: this.config, funcs: funcs || this.config.funcs, fields: fields || this.config.fields, value: normalizedValue, onChange: onChange, classnames: cx, removeable: false, onDragStart: this.handleDragStart, showNot: showNot, data: data, disabled: disabled }));
    };
    var _a, _b, _c;
    tslib_1.__decorate([
        helper_1.autobind,
