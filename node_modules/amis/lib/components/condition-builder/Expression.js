...
var Expression = /** @class */ (function (_super) {
    ...
    Expression.prototype.render = function () {
        var _a, _b, _c, _d, _e;
        var _f = this.props, value = _f.value, valueField = _f.valueField, allowedTypes = _f.allowedTypes, funcs = _f.funcs, fields = _f.fields, op = _f.op, cx = _f.classnames, config = _f.config, data = _f.data, disabled = _f.disabled;
        ...
        return (react_1.default.createElement(react_1.default.Fragment, null,
            ...
            inputType === 'field' ? (react_1.default.createElement(Field_1.default, { value: (_d = value) === null || _d === void 0 ? void 0 : _d.field, onChange: this.handleFieldChange, disabled: disabled, options: valueField
                    ? helper_1.filterTree(fields, function (item) {
                        return item.children ||
                            item.type === valueField.type;
                    })
                    : fields })) : null,
            inputType === 'func' ? (react_1.default.createElement(Func_1.default, { config: config, value: value, onChange: this.handleFuncChange, funcs: funcs, fields: fields, allowedTypes: allowedTypes, disabled: disabled })) : null,
